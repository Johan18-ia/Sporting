// frontend_web/frontend/src/models/ScheduleModel.js
...
class ScheduleModel {
  ...
  static async getSchedulesByCategory(categoryId) {
    try {
  ...
  static async deleteSchedule(id) {
    try {
      const endpoint = API_CONFIG.ENDPOINTS.SCHEDULE_DELETE.replace(':id', id)
